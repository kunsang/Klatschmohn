...
class ThemeShortcodeCalltoaction extends ThemeShortcode {
    ...
    public function process($atts, $content=null) {
		...
		return sprintf('
			<div class="honey-cta-message-full" style="background-image: url(\'%s\');">
				<div class="container">
					<div class="honey-cta-message-full-inner">
						'.do_shortcode('[column class="4/5"]<h2>%s</h2><p>%s</p>[/column]').'
						'.do_shortcode('[column class="1/5 last"]<a href="%s" target="_blank" class="tp-button red big">%s</a>[/column]').'
